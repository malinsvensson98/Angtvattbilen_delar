...
<h1> <?php the_title();?> </h1>
<br/>
<br/><a href="<?php echo site_url('/work'); ?>">Tillbaka till översikt (arkiv) </a>
<br/><br/><br/>
</div>
    ...
    <?php 
     if (have_posts()){
         while(have_posts()){ 
            ...
            <button class="editWork"><i class="fa fa-pencil" aria-hidden="true"></i> Ändra</button>
            <button class="saveUpdateWork"> <i class="fa fa-arrow-right" aria-hidden="true"></i> Spara ändringar </button>
            <br/><br/>
            <h4>Titel</h4>
            <input readonly class="singleField"  class="updateTitle" value="<?php the_title(); ?>"> <br/><br/>
            <h4>Kundnamn</h4>
            <input readonly class="singleField" class="updateKundnamn" value="<?php echo esc_attr(the_field(kundnamn)); ?>"> <br/><br/>
              <h4>Adress</h4>
              <input readonly class="singleField" class="updateAdress" value="<?php echo esc_attr(the_field(adress)); ?>"> <br/><br/>
             <h4>Startdatum</h4>
             <input readonly class="singleField" class="updateStartdatum" value="<?php echo esc_attr(the_field(startdatum)); ?>"> <br/><br/>
             <h4>Slutdatum</h4>
             <input readonly class="singleField" class="updateSlutdatum" value="<?php echo esc_attr(the_field(slutdatum)); ?>"> <br/><br/>
             <h4>Typ av arbete</h4>
